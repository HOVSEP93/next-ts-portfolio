    ...
    return (
        ...
        >
            ...
            <p className="text-gray-800 dark:text-gray-200 mb-6">
                Have an inquiry, or want to connect? Feel free to leave a message below, or get in touch via Twitter, or
                email.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 md:gap-4 mb-20">
                ...
                <div className="row-start-1 md:row-auto">
                    <ContactLink
                        ...
                        link="https://twitter.com/hovsepantranig?s=21&t=vPEI6hD08DPVl8gp-udZhw"
                        borderColor="hover:border-[#1DA1F2]/50"
                    />
                    <ContactLink
                        name="hello@hovsepantranig"
                        icon={<FiMail className="w-6 h-6 text-gray-400" />}
                        link="mailto:hovsepantranig@gmail.com                        "
